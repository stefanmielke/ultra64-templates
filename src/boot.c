...
void boot(void) {
	...
	osCreateThread(&idleThread, 1, idle, NULL, idleThreadStack + STACKSIZE / sizeof(u64), 10);
...
static void mainproc(void *arg) {
	 ...
	 */
	textureSegment = staticSegment + (u32)_staticSegmentRomEnd - (u32)_staticSegmentRomStart;
